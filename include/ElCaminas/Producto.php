...
class Producto
{
    ...
    public function getHtmlExclusive(){

      $str = "<h2 class='subtitle' style='margin:0'>".$this->nombre."</h2>";
      $str .= "<img class='center-block img-responsive img-thumbnail' src='./basededatos/img/600_" . $this->foto . "' alt=''>";
      $str .="<div class='caption' style='margin-top:10px;'><p class='lead'>".$this->descripcion.".</p></div>";
      $str .= "<span class='text text-success'>".$this->getHtmlPrecio()."</span></h4><a href='./carro.php?action=add&id=" . $this->id . "&cantidad=1&redirect=" . urlencode($_SERVER["REQUEST_URI"]) . "' class='btn btn-danger' style='position:absolute; bottom:4px; right:4px'>Comprar</a>";
      $str .= "</div>";
      ...
      $str = "<div class='col-sm-4 col-lg-4 col-md-4'>";
        $str .= "<div class='thumbnail' style='position:relative'>";
          ...
          $str .= "<div class='caption'>";
            ...
            $str .= "<a class='open-modal' href='" . $this->url . "'><span class='fa fa-external-link'></span></a></h4>";
            $str .= "<p>". $this->descripcion . "</p>";
          $str .= "</div>";
    ...
    public function getJson(){
     return json_encode(array("HOME"=> "/tiendaOOP/", "id" => $this->id, "nombre" => $this->nombre, "foto" => $this->foto, "descripcion" =>  $this->descripcion, "precio" => $this->getHtmlPrecio()));
   }
